...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(
            app_label='documents', model='document') # model must be lowercase!
        perm, created = orm['auth.permission'].objects.get_or_create(
            content_type=ct, codename='view_documents',
            defaults=dict(name=u'Can view documents read-only'))
        
    def backwards(self, orm):
        "Write your backwards methods here."
        orm['auth.permission'].objects.filter(
            codename='view_documents').delete()
    ...
    complete_apps = ['contenttypes', 'auth', 'documents']
    symmetrical = True
