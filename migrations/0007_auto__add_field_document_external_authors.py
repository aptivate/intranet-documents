...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.external_authors'
        db.add_column('documents_document', 'external_authors', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.external_authors'
        db.delete_column('documents_document', 'external_authors')
