...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Document.uploader'
        db.add_column('documents_document', 'uploader', self.gf('django.db.models.fields.related.ForeignKey')(related_name='documents_uploaded', null=True, to=orm['binder.IntranetUser']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.uploader'
        db.delete_column('documents_document', 'uploader_id')
